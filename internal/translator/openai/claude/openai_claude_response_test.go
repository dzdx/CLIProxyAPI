...
func TestConvertOpenAIResponseToClaude_StreamToolCallIgnoresEmptyNameDeltas(t *testing.T) {
	events := convertOpenAIStreamTestEvents(t, []string{
		...
		`data: {"id":"chatcmpl-test","object":"chat.completion.chunk","created":1,"model":"gpt-test","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"function":{"name":null,"arguments":"\":\"pwd\"}"}}]},"finish_reason":null}]}`,
